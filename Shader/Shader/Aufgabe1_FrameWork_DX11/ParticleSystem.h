...
private:
	...
	DirectX::XMFLOAT4 m_WorldUpVector = {0.0f,1.f,0.0f,0.0f};
	float m_StartingVelocity = 1.0f;
	float m_Gravity = 0.1f;
	unsigned int m_maximumLifetime = 1000;
	unsigned int m_maximumNumberOfParticles = 4096;
};
